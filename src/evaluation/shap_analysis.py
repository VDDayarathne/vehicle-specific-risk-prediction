...
print("\n[1] Loading data...")
_ROOT = BASE_DIR.parents[1]
_DATA = _ROOT / "data" / "processed"
X = pd.read_csv(_DATA / "engineered_features.csv")
y = pd.read_csv(_DATA / "target_severity.csv").squeeze()
...
PRETTY_LABELS = {
    ...
    "slope_x_curve":     "Slope x Curvature",
    "is_low_vis":        "Low visibility flag",
    "high_risk_combo":   "High-risk combo",
    "rain_x_curve":      "Rain x Curvature",
    "vis_x_night":       "Visibility x Night",
    ...
    "vis_rain_prod":     "Visibility x Rain",
...
report_lines = [
    ...
    "   - The slope x curvature interaction shows non-linear compounding",

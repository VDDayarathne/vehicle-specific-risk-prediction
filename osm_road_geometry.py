...
if __name__ == "__main__":
    ...
    # 4. Save road segments
    out_roads = "kadugannawa_road_segments.csv"
    ...
    merged.to_csv("accidents_with_osm_features.csv", index=False)
    print(f"Saved: accidents_with_osm_features.csv")
